//
//  ChooseWeatherDetailsViewController.swift
//  WeatherApp
//
...
class ChooseWeatherDetailsViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        Apicall(String(longitude), String(latitude))
...
//        let hourly:[subHourly]
    ...
    func Apicall(_ long: String,_ lat: String) {
